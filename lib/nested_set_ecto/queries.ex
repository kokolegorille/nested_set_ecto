defmodule NestedSetEcto.Queries do
  @moduledoc """
  Documentation for NestedSetEcto.Queries
  Returns common nested set queries
  """
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      def self_and_siblings(%__MODULE__{parent_id: parent_id} = _resource)
      ...
      def leaves,
        do: from(r in __MODULE__, where: fragment("? + 1", r.lft) == r.rgt, order_by: :lft)
    end
  end
end
